...
def main():
    ...
    parser.add_argument('--input-file', type=str, help='Single voxel file to process.')
    ...
    if args.input_file:
        ...
        dataset = VoxelDataset(args.input_file)
    ...
    # Load checkpoint
    checkpoint_io = config.CheckpointIO(out_dir, model=model)
    ...
    generate_pointcloud = cfg['generation'].get('generate_pointcloud', False)
    ...
    for it, data in enumerate(tqdm(test_loader)):
        ...
        if generate_mesh:
            ...
            print(f'Generated mesh: {mesh_out_file}')
    ...
    print(f'Generation completed. Results saved to: {generation_dir}')
